...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
	...
	<main class="form-signin w-100 m-auto">
		<form name = "f" action = "findpw_pro.jsp">
		<a href = "../main/main.jsp">
			...
			<div class="btn-group w-100 py-2" role="group" aria-label="Basic example" style = "margin-top: 30px">
	  			<button type="button" class="btn btn btn-light w-100 py-2" style = "border: 1px solid gray;" onclick = "location.href='findid.jsp'">아이디 찾기</button>
	  			<button type="button" class="btn btn btn-light w-100 py-2" style = "border: 1px solid gray;" onclick = "location.href='findpw.jsp'">비밀번호 찾기</button>
			</div>

			<label for="country" class="form-label" style = "margin-top: 30px">아이디</label>
			<div class="form-floating">
				<input type="text" class="form-control mb-2" id="floatingInput" name = "id"
					placeholder="name@example.com"> <label for="floatingInput">아이디 입력</label>
			</div>

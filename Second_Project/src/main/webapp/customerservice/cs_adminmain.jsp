...
<form method="post" name = "myform" action = "cs_admin_articleDelAll.jsp?pageNum=<%=pageNum%>">
<div class="table-responsive small">
		<div style = "margin-bottom: 10px;" class="d-flex gap-2 w-100 justify-content-between">
		  <h5><b>글목록(전체 글:<%= count %>)</b></h5>
      		<div class="d-grid gap-2 d-md-block">
         		<button class="btn btn-outline-dark btn-md" type="button" onClick = "selectDelete()">글삭제</button>
        	</div>
      	</div>
        ...
        <table class="table table-striped table-sm">
          <thead>
            <tr align ="center" id = "a">
              <th width = "5%"><input id = "bbb" class="form-check-input" type="checkbox" name = "allcheck" onclick = "allCheck(this)"></th>
	      ...
	      %>
            <tr align ="center">
              <td><input class="form-check-input" type="checkbox" id="procheck" name = "rowcheck" value = "<%=bb.getNum()%>"></td>
              <td><%= number-- %></td>
              <td>
              <%
               int wid = 0;
            ...
            %>
         <a href = "cs_admin_content.jsp?num=<%=bb.getNum()%>&pageNum=<%=currentPage%>">
         <%= bb.getSubject() %>
         </a>
         <%
      ...
      %>
             <li class="page-item">
      			<a style="color: black;" class="page-link" href="cs_adminmain.jsp?pageNum=<%= startPage-pageBlock %>" aria-label="Previous">
      ...
      %>
      		<li class="page-item" ><a style="color: black;" class="page-link" href="cs_adminmain.jsp?pageNum=<%= i %>"><%=i%></a></li>
      <%   
         }
         if(endPage < pageCount){ 
      %>
            <li class="page-item">
      			<a style="color: black;" class="page-link" href="cs_adminmain.jsp?pageNum=<%= startPage+pageBlock %>" aria-label="Next">

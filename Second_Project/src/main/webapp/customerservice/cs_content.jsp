 ...
 <form method="post" name="writeForm" action="cs_write_proc.jsp">
  ...
  <div class="d-flex gap-2 w-100 justify-content-center">
      	<div class="d-grid gap-2 d-md-block mx-auto">
         		 <button class="btn btn-primary btn-md" type="button" onClick = "location.href = 'cs_update_form.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>'">글수정</button>
         		 <% if(bb.getRe_level()>0) {%>
         		 <button class="btn btn-primary btn-md" disabled type="button" onclick="location.href='cs_write_.jsp'">글삭제</button>
         		 <%} else {%>
         		 <button class="btn btn-primary btn-md" type="button" onclick="location.href='cs_delete_form.jsp?num=<%=bb.getNum()%>&pageNum=<%=pageNum%>'">글삭제</button>
         		 <%} %>
         		 <button class="btn btn-primary btn-md" type="button" onclick = "location.href='cs_main.jsp'">글목록</button>
        </div>
      </div>

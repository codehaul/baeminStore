...
<div class="container">
<h1 style = "margin-top: 10px;">답글 쓰기</h1>
 <form method="post" name="writeForm" action="cs_admin_reply_pro.jsp">
  ...
  <table class="rwd-table">
    <tbody>
      <tr>
        <th>이름</th>
        <td><input type="text" name="writer" maxlength="10" <%= name %>></td>
      </tr>
      <tr>
        <th>제목</th>
      ...
      <tr>
        <th>글내용</th>
        <td><textarea name="content" id="ta" rows="15" cols="50" style = "resize:none;"></textarea></td>
      </tr>
      <tr>
        <th>비밀번호</th>
  ...
  <div class="d-flex gap-2 w-100 justify-content-center">
      	<div class="d-grid gap-2 d-md-block mx-auto">
         		 <button class="btn btn-primary btn-md" type="submit">답글쓰기</button>

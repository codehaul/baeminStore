...
ArrayList<String> comlists = pdao.getCompanyList();
...
<% 
for(String company : comlists){
	plists = pdao.getSelectByCompany(company);
%>
		
	<div class="container">
		<div class="b mt-3">
			<font class="text-body-black" size = "5"><b>(주)<%= company %>(<%= plists.size() %>)</b></font>
		</div>

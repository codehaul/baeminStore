        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-secondary" onclick = "goLogin()"><font>구매</font></button>
                  <button type="button" class="btn btn-sm btn-outline-secondary" onclick = "goLogin()"><font>장바구니</font></button>
                </div>
              </div>
            </div>
          </div>
